...
EXPORT flightRecMod := MODULE
    ...
    EXPORT flightRec := RECORD
        STRING3             Carrier;                                // Two or three letter code assigned by IATA or ICAO for the Carrier oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
